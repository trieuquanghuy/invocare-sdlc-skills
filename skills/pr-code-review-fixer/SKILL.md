...
description: "Use when the user asks to address, fix, apply, resolve, triage, or process PR review comments, reviewer feedback, code review suggestions, or automated review findings, especially in the InvoCare FireHawk / Barndoor workspace. Sources include a GitHub PR number, URL, or branch, a manager-hub CUID, or a local code-review-result.json from the pr-reviewer agent."
